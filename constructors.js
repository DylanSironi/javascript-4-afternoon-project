...
// console.log(bob)
  ...
  */
  ...
  const starWars = new Movie('Star Wars', 'Action', 90)
  ...
  // Once the User constructor function is created, write a prototype method for the User function. Name this method addSavedPost. It should take in three parameters: id (a number), 
  // title (a string) and rating (a number). Use these parameters to create a new object and add it to the savedPosts array. Make sure to name the properties the same as described 
  // previously (id, title, rating).
  ...
  // Write a prototype method for the User constructor function named removeSavedPost that will take in one number parameter representing the post id. Use this id to find and remove 
  // the matching object in the savedPosts array.
  ...
  // Write a prototype method for the User constructor function named changePostRating that will take in two number parameters. The first will be an id (a number) and the second will 
  // be the new rating (a number). Use the id to find the matching object in the savedPosts array. Once you find the matching object, update it's rating score with the new rating 
  // parameter.
  
  // Code here

  User.prototype.changePostRating = function(id, newRating) {
    this.savedPosts.map(i => i.id === id ? i.rating = newRating : null)
  }